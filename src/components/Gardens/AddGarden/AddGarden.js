...
export default function AddGarden() {
  return (
    <div className="w-full h-screen bg-gray-50">
      <div className="w-full p-10 flex flex-col justify-center  gap-6">
          ...
          <div className="sm:columns-1 md:columns-2 gap-x-8">
            <div>
              ...
              <Input
                ...
                placeholder="expected harvest size"
              />
            </div>
            <div>
              <Input type="text" title="Crop breed" placeholder="crop breed" />
              <Input type="text" title="Season" placeholder="season" />
              <Input
                type="text"
                title="Measurement"
